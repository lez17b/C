//
// Created by Luciano  Zavala zelada on 01/15/21.
//

#ifndef UNTITLED27_TLIST_H
#define UNTITLED27_TLIST_H
#include <iostream>
#include <utility>
#include "tnode.h"
// **********************************************************
...
TList<T> operator+(const TList<T>& t1, const TList<T>& t2)
{
    ...
    //if t2 is empty, we can return immediately
    if (t2.GetSize() == 0)
        return result;
